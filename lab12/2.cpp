...
/*구현*/ //override 키워드 사용한 get()함수 구현, main함수 참고하여 출력화면처럼되도록 구현
...
class FixedText : public Text {
	public:
		...
		void append(string _extra) override { return ; };
	/*구현*/ //override 키워드 사용한 append()함수 구현, main함수 참고하여 출력화면처럼되도록 구현
};
